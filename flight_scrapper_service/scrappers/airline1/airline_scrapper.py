...
class AirlineSearch:
    def __init__(self):
        ...
        # options.set_capability('se:name', 'airline scrapper')
        selenium_hub = "http://127.0.0.1:4444"
        driver = webdriver.Remote(options=options, command_executor=selenium_hub)
        self.driver = driver
    ...
    def get_info_site(self):
        ...
        try:
            ...
            print(f"tittle: {driver.title}")
            elem = driver.find_element(By.CLASS_NAME, "list-widgets")
            menu_elements = elem.find_elements(By.CLASS_NAME, "menu")
    ...
    def get_flights(self) -> List:
        ...
        driver = self.driver
        try:
            driver.get("https://www.avianca.com/es/booking/select/?origin1=BOG&destination1=GPS&departure1=2024-06-14&adt1=1&tng1=0&chd1=0&inf1=0&origin2=GPS&destination2=BOG&departure2=2024-06-17&adt2=1&tng2=0&chd2=0&inf2=0&currency=USD&posCode=CO")
